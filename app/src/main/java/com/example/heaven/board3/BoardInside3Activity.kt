...
import com.example.heaven.databinding.ActivityBoardInside2Binding
import com.example.heaven.databinding.ActivityBoardInside3Binding
...
class BoardInside3Activity : AppCompatActivity() {

    private val TAG = BoardInside3Activity::class.java.simpleName

    private lateinit var binding : ActivityBoardInside3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_board_inside3)
    ...
    private fun showDialog(){
        ...
        alertDialog.findViewById<Button>(R.id.editBtn)?.setOnClickListener {
            ...
            val intent = Intent(this, BoardEdit3Activity::class.java)
