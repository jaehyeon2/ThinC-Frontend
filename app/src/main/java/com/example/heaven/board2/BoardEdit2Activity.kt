...
import com.example.heaven.databinding.ActivityBoardEdit2Binding
...
class BoardEdit2Activity : AppCompatActivity() {

    private lateinit var key:String

    private lateinit var binding : ActivityBoardEdit2Binding

    private val TAG = BoardEdit2Activity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_board_edit2)
    ...
    private fun editBoard2Data(key : String){
        ...
        FBRef.boardRef2
            .child(key)
            .setValue(
                BoardModel2(binding.titleArea.text.toString(),
