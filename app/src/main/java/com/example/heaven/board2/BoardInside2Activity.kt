...
class BoardInside2Activity : AppCompatActivity() {

    private val TAG = BoardInside2Activity::class.java.simpleName
    ...
    private fun showDialog(){
        ...
        alertDialog.findViewById<Button>(R.id.editBtn)?.setOnClickListener {
            ...
            val intent = Intent(this, BoardEdit2Activity::class.java)
